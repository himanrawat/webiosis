...
const scriptURL = 'https://script.google.com/macros/s/AKfycbyvrVDECz9pT_mOvmK6sdYc_PGWe7vFHBQXZxob_SztApaSPTTC3J_gt4O7V0e7Kk8/exec';
  ...
  return (
    <>
      ...
      <p className="text-neutral-600 text-sm max-w-sm mt-2 dark:text-neutral-300">
        ...
        <form className="my-4" ref={formRef} onSubmit={handleSubmit} name="demo-form">
          <LabelInputContainer className="mb-4">
            <Label htmlFor="firstname">Full name</Label>
            <Input id="firstname" name="firstname" placeholder="Tyler Swift" type="text" required />
          </LabelInputContainer>
          ...
          <LabelInputContainer className="mb-4">
            ...
            <Input id="phone" name="phone" placeholder="0000000000" type="tel" required />
          </LabelInputContainer>
          ...
          <LabelInputContainer className="mb-4">
            ...
            >
              ...
              <option value="platform-infrastructure">Platform and Infrastructure</option>
            </select>
          </LabelInputContainer>
